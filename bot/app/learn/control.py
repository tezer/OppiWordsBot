...
#     :param query: receives a query reply formed in start_learning_message
#     :param callback_data: -1 - learning all words, >= list number from the menu
#     :return:
#     """
...
#         # FIXME does it for the second time (first time it was done in start_learning_message
#         hids = sr.get_items_to_learn(
#             (session.get_user_id(), session.active_lang()),
